...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        ...
        if who == 0:
            diff0 = score0 - previous_score
            if diff0 > previous_high:
                previous_high = diff0
                if previous_high == 1:
                    print(previous_high, "point! That's the biggest gain yet for Player 0")
                else: 
                    print(previous_high, "points! That's the biggest gain yet for Player 0")
            previous_score = score0
        else:
            diff1 = score1 - previous_score
            if diff1 > previous_high:
                previous_high = diff1
                if previous_high == 1:
                    print(previous_high, "point! That's the biggest gain yet for Player 1")
                else: 
                    print(previous_high, "points! That's the biggest gain yet for Player 1")
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while count <= 10:
        ...
        current = average(count, dice)
        if current >= previous:
            previous, highest_value = current, count
        count += 1
